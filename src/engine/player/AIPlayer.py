...
class AIPlayer(Player):
    ...
    def __init__(self, mark, name, engine):
        self.stats = Stats()
        self.last_move_key = ''
    ...
    def make_move(self):
        ...
        for i in range(0, len(possible_moves)):
            ...
            random_beta = random.betavariate(self.number_of_rewards_1[possible_move_key] + 1, self.number_of_rewards_0[possible_move_key] + 1)
